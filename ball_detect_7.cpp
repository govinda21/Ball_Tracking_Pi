...
int main(int argc, char** argv)
{
	...
	// This loop is just have written to avoid bad quality image captured during the beggining of  streaming from Raspberry Pi camera.
	...
	{			
		...
		*/
		...
		if(assigned)
		{
			...
			fs<<color_name<<"{:";
			fs<<"m_LowH"<<m_LowH;		// Write the lower Hue value in the test.yml under the name_color(ther color which you have specified)
			fs<<"m_HighH"<<m_HighH;	// Write the higher Hue value in the test.yml under the name_color(ther color which you have specified)
			fs<<"m_LowS"<<m_LowS;		// Write the lower S value in the test.yml under the name_color(ther color which you have specified)
			fs<<"m_LowV"<<m_LowV;		// Write the lower V value in the test.yml under the name_color(ther color which you have specified)
			fs<<"}";
